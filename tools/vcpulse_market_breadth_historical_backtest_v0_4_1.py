#!/usr/bin/env python3
"""VCPulse Market Breadth Historical Backtest v0.4.1
...
# Make repository-root modules importable when this script is executed as
# `python tools/...py` in GitHub Actions.
